const Users = (props) => {
  ...
  if (props.users.length === 0){
    props.setUsers([
    { id: 1, followed: true, name: "Sarah", profession: "Designer", avatar: "https://images.pexels.com/photos/61100/pexels-photo-61100.jpeg?crop=faces&fit=crop&h=200&w=200&auto=compress" },
    { id: 2, followed: false, name: "Ricky", profession: "Designer", avatar: "https://sun2.6789.userapi.com/s/v1/ig2/XPm59-anwj04J3iCzGan1-xEUIUUELaAL9lLMOoqWbqa-nLoVlBeMVW98OQ5olXgHEosP-Y3pN6orlNxcWs5o1zf.jpg?size=100x0&quality=96&crop=21,85,385,385&ava=1" },
    { id: 3, followed: false, name: "Dexter", profession: "Director", avatar: "https://i.imgur.com/JFHjdNr.jpg" },
    { id: 4, followed: true, name: "Johnny", profession: "CEO", avatar: "https://i.imgur.com/zLCYdR9.jpg" }
    ])
  }
